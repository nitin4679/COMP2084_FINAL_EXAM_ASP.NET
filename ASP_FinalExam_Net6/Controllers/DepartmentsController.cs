...
namespace ASP_FinalExam_Net6.Controllers
{
    public class DepartmentsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,EmployeeCount,EmployeeId")] Department department)
        {
            ...
            ViewData["EmployeeId"] = new SelectList(_context.Set<Employee>(), "Id", "Name", department.EmployeeId);
            return View(department);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,EmployeeCount,EmployeeId")] Department department)
        {
            if (id != department.Id)
            {
                return NotFound();
